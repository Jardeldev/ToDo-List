<template>
    <div class="add-div bg-gray-300 rounded-sm">
        <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
            <div class="flex items-center justify-center mr-2">
                <button 
                :class="{'text-green-600': isCompleted, 'text-gray-400': isCompleted,}" @click="onCheckClick">
...
export default {
    ...
    data() {
        return {
            ...
            userEmail: this.todo.userEmail,
            criadoEm: this.todo.criadoEm,
    ...
    methods: {
        onTitleChange() {
            if(!this.title, !this.userEmail, !this.criadoEm) {
                return 
            }
